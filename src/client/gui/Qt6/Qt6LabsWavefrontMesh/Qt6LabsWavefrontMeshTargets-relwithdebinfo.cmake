...
set_target_properties(Qt6::LabsWavefrontMesh PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsWavefrontMesh.so.6.3.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsWavefrontMesh.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LabsWavefrontMesh )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LabsWavefrontMesh "${_IMPORT_PREFIX}/lib/libQt6LabsWavefrontMesh.so.6.3.1" )
