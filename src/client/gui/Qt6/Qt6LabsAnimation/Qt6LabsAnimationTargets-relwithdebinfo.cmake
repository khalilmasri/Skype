...
set_target_properties(Qt6::LabsAnimation PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsAnimation.so.6.3.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsAnimation.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LabsAnimation )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LabsAnimation "${_IMPORT_PREFIX}/lib/libQt6LabsAnimation.so.6.3.1" )
